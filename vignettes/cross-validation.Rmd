...
```{r, fig.cap = "Results from model tuning using `cv_sgdnet()`.", fig.width = 7, fig.height = 5}
...
best performance, here $\alpha = 0.1$. We can now use this model together
with the $\lambda$ corresponding to the best model to make predictions
